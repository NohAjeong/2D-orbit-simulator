...
for vy in velocities:
    pos,_= simulate(dt=0.01, vy_init=vy)
    plt.plot(pos[:,0], pos[:,1], label=f"vy={vy}")

plt.legend()
plt.title("Orbit vs Initial velocity")
plt.axis("equal")
plt.savefig("velocity_experiment.png", dpi=300)
plt.show()